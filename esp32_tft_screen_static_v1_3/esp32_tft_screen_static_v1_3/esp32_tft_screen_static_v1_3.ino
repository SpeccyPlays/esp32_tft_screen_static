...
class screenStatic {
  public:
    void start(byte tempStaticStartPosition, byte tempHeight, byte tempWidth, byte tempStaticHeight, byte tempPixelSize, unsigned char *tempBackground){
  ...
  void displayStaticBar(){
      ...
      myScreen.fillRect(0, staticStartPosition, screenHeight, 2, TFT_BLACK);
//      myScreen.drawXBitmap(0 ,0, background, screenHeight, screenWidth, TFT_WHITE);
